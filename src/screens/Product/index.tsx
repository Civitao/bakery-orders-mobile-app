  ...
  const [requestFlavor, setRequestFlavor] = useState(false);
    ...
    function addItemToCart () {
      ...
      if(selectedFlavor === 'Selecione um sabor') {
        ...
        }).then(() => setTimeout(() => { setActiveAddedItemModal(true) },180)   
...
//==================================================
  ...
  return (
    ...
    onPress={() => {setActiveAddedItemModal(!activeAddedItemModal); navigation.goBack()}}
    ...
    >
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.flavorsNQuantity}>
          ...
          <View style={styles.flavorsContainer}>
            ...
            style={styles.dropdownContainer}>
              ...
              <Text style={styles.dropdownText}>{selectedFlavor}</Text> 
        ...
        <View style={styles.quantityContainer}>
          ...
          <TouchableOpacity onPress={() => minusItemQuantity()} 
          ...
          <Text style={styles.quantityInt}> {itemQuantity} </Text>
