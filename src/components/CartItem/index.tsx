  ...
  return (
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.itemQuantity}> Quantidade:{data.quantity}   </Text>
        <Text style={styles.itemFlavor}> {data.flavor}   </Text>

        <Text style={styles.itemPrice}> R${priceFormat.toFixed(2).replace('.',',')}   </Text>
